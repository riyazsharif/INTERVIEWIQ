...
function Pricing() {
  ...
  const [lodingPlan, setLodingPlan] = useState(null);
  ...
  const handlePayment = (plan) => {
    try {
      setLodingPlan(plan.id);

      const amoutn = plan.price === "basic" ? 100:
        plan.price === "pro" ? 500 : 0;
      ...
      ${
        isSelected
          ...
          : "bg-gray-100 text-gray-700 hover:bg-emerald-50"
                  ...
                  {lodingPlan === plan.id ? "Processing..." : isSelected ? "Proceed to Pay" : "Select Plan"}
                </button>
              )}
            </motion.div>
          );
